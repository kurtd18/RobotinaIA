...
def _calcular_caracteristicas(data):
    ...
    construcción propia de la fórmula)."""
    ...
    caracteristicas["macd"] = macd_df["MACD_12_26_9"] if macd_df is not None else None
    caracteristicas["macd_hist"] = macd_df["MACDh_12_26_9"] if macd_df is not None else None
    caracteristicas["macd_pendiente"] = (
        macd_df["MACD_12_26_9"] - macd_df["MACD_12_26_9"].shift(3) if macd_df is not None else None
    )
...
def correr():
    ...
    nombres_caracteristicas = [
        ...
        "macd", "macd_hist", "macd_pendiente", "bollinger_pctb",
